...
/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P $SA_PASSWORD -d DiplomskiDb -i /opt/scripts/schema.sql;
/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P $SA_PASSWORD -d DiplomskiDb -i /opt/scripts/seed.sql;
